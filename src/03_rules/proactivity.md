...
- **Fallback**: Ask ONLY if search yields 0/conflicting results, OR if you find multiple equally valid targets/interpretations. Acknowledging ambiguity and asking is encouraged defense, not a lack of proactivity. Show search attempts.
